...
// This File   : ResultWindowsDlg.cpp
...
ResultWindowsDlg::ResultWindowsDlg(CWnd* pParent /*=nullptr*/)
	               :StyleDialog(IDD_RESULTVIEWER_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);

  m_tab1 = new ValidationsDlg(this);
  m_tab2 = new WINOutputDlg(this);
}

ResultWindowsDlg::~ResultWindowsDlg()
{
  delete m_tab1;
  delete m_tab2;
}
...
void 
ResultWindowsDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(ResultWindowsDlg, StyleDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void
ResultWindowsDlg::SetupDynamicLayout()
{
...
void
ResultWindowsDlg::LoadVariables()
{
...
void
ResultWindowsDlg::LoadVariablesTabs()
{
...
void 
ResultWindowsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR ResultWindowsDlg::OnQueryDragIcon()
{
