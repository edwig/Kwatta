...
// This File   : ResultDatabaseDlg.cpp
...
ResultDatabaseDlg::ResultDatabaseDlg(CWnd* pParent /*=nullptr*/)
	                :StyleDialog(IDD_RESULTVIEWER_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);

  m_tab1 = new ValidationsDlg(this);
  m_tab2 = new SQLDataDlg(this);
  m_tab3 = new SQLStatusDlg(this);
}

ResultDatabaseDlg::~ResultDatabaseDlg()
{
  delete m_tab1;
  delete m_tab2;
  delete m_tab3;
...
void 
ResultDatabaseDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(ResultDatabaseDlg, StyleDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CResultDatabaseDlg message handlers
...
void
ResultDatabaseDlg::SetupDynamicLayout()
{
...
void
ResultDatabaseDlg::InitTabs()
{
  m_tab1->Create(IDD_VALIDATIONS, &m_tabs);
  m_tab2->Create(IDD_SQL_DATA,    &m_tabs);
...
void
ResultDatabaseDlg::LoadVariables()
{
...
void
ResultDatabaseDlg::LoadVariablesTabs()
{
...
void 
ResultDatabaseDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR ResultDatabaseDlg::OnQueryDragIcon()
{
